...
namespace ariketa1
{
    public partial class hegazkina_window : Window
    {
        private const int TOTAL_ASIENTOS = 40;
        private const string RUTA_JSON = "hegazkina.json";

        private ReservaVehiculo reservaVehiculo;
        private readonly Random random = new();
        private readonly DateTime fechaReserva;

        public hegazkina_window(DateTime fechaReserva, string tipoVehiculo)
        {
            InitializeComponent();
